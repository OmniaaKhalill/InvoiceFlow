    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<InvoiceHeader>().HasData(
                new InvoiceHeader { ID = 2, CustomerName = "محمد عبد الله", Invoicedate = DateTime.Parse("2022-02-22"), CashierID = 1, BranchID = 2 },
                new InvoiceHeader { ID = 3, CustomerName = "محمود احمد", Invoicedate = DateTime.Parse("2022-02-23"), CashierID = 2, BranchID = 3 }
            );
